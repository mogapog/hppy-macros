...
To install it, first download the latest release from [Releases](https://github.com/mogapog/hppy-macros/releases) and unzipt it. Then open a terminal in the "/hppymacro/" directory and then type the following commands:  
